...
urlpatterns = [
    ...
    path('customer/import/<int:client_id>/delete', management.views.delete_client, name='delete_client'),
    path('customer/import/<int:client_id>/delete-confirmation', management.views.delete_client_confirmation, name='delete_client_confirmation'),
